...
void cgit_print_docend(void)
{
	...
	if (ctx.cfg.footer)
	    ...
	    */
	    ...
	    html("created for <a href=\"http://aselab.edu.vn/\">ASE Laboratory</a> - "
	            "<a href=\"http://fet.hust.edu.vn/index.php/en/department/aerospace/overview-dthk\">"
	                "Department of Aerospace Electronic</a><br>\n");
	    html("School of Electronics and Telecommunication - Hanoi University of Science and Technology<br>\n");
	    html("maintained and edited by Bao Son Le, Cong Thanh Nguyen, Duc Phuc Tran<br>\n");
		htmlf("generated by <a href='http://git.zx2c4.com/cgit/about/'>cgit %s</a> at ",
		    cgit_version);
...
static void print_header(void)
{
	...
	if (logo && *logo) {
		...
		html("'><img src='");
		html_attr(logo);
		html("' alt='cgit logo' height='72' width='72' /></a></td>\n");
	}
